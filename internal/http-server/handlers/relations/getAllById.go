...
type RelationProvider1 interface {
	AllRelations(id int64) ([]models.Relation, error)
}

func AllById(log *slog.Logger, provider RelationProvider1) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		relation, err := provider.AllRelations(int64(intId))
		if err != nil {
